...
/// stays decoupled from `vuio-codec-core`:
///
/// ```ignore
/// pub fn register(ctx: &mut vuio_codec_core::RuntimeContext) {
///     /* install factories */
/// }
///
/// #[cfg(feature = "registry")]
/// vuio_codec_core::register!("aac", register);
/// ```
///
/// The macro expands to a `pub fn __oxideav_entry(ctx)` wrapper that
/// invokes the supplied function.
///
...
macro_rules! register {
    ($name:literal, $func:path) => {
        ...
        ///
        /// Generated by the [`vuio_codec_core::register!`] macro; do not
        /// invoke directly.
        #[doc(hidden)]
