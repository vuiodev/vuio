...
///
/// ```rust
/// use vuio_codec_dts::joint_source_channel;
///
...
pub fn joint_source_channel(joinx: u8) -> Option<u8> {
    if joinx == 0 { None } else { Some(joinx - 1) }
}
...
///
/// ```rust
/// use vuio_codec_dts::joint_subband_decode_range_i32;
///
...
///
/// ```rust
/// use vuio_codec_dts::joint_subband_decode_range_f64;
///
