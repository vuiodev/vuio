...
pub(super) async fn start_platform_adaptation<D: DatabaseManager + 'static>(
...
pub(super) async fn detect_platform_with_diagnostics() -> anyhow::Result<PlatformInfo> {
...
pub(super) async fn initialize_file_watcher(
    config: &AppConfig,
