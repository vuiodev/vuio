...
brew install vuio</pre>
        ...
        <footer>
            <p>VuIO Media Server &bull; <a href="https://github.com/vuiodev/vuio">GitHub Repository</a> &bull; <a href="https://github.com/vuiodev/vuio/blob/main/docs/install.md">Detailed Installation Guide</a></p>
        </footer>
    </div>
</body>
</html>
